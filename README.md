...
1. Kết nối nguồn cho vi điều khiển ATmega16 và mạch động lực L298N.
2. Kết nối Raspberry Pi. Tại terminal của Pi, chạy file thực thi chính:
...
1. Mở trình duyệt web trên máy tính/điện thoại dùng chung mạng Wi-Fi với Raspberry Pi.
2. Truy cập vào địa chỉ IP của Pi với cổng 5000 (Ví dụ: [http://192.168.1.100:5000](http://192.168.1.100:5000)).
3. Chuyển sang chế độ **AUTO** để xe bắt đầu tự hành, hoặc dùng các nút điều hướng để lái xe bằng tay.
...
## 👨‍💻 Tác giả
* **Phan Nhật Anh, Nguyễn Việt Anh, Hà Đại Dương** - *Thiết kế kiến trúc, phát triển phần mềm và phần cứng.*
